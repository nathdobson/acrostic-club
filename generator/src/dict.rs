...
use crate::{read_path_to_string, PACKAGE_PATH};
...
pub static FLAT_WORDS: LazyLock<PersistentFile<Vec<FlatWordBuilder>>> =
    LazyLock::new(|| PersistentFile::new(&PACKAGE_PATH.join("build/dict.dat")));
